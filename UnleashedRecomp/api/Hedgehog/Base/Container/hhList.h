...
namespace hh
{
    ...
    protected:
        struct SNode
        {
            ...
            xpointer<SNode> pNext;
            xpointer<SNode> pPrev;
            T Value;
        };
        ...
        template<class... Args>
        xpointer<SNode> Emplace(xpointer<SNode> in_pNode, Args&&... args)
        {
            xpointer<SNode> in_pNewNode = m_Alloc.allocate(1);
    ...
    public:
        ...
        public:
            ...
            iterator(xpointer<SNode> pNode) : m_pNode(pNode) {}
        ...
        public:
            ...
            const_iterator(xpointer<SNode> pNode) : m_pNode(pNode) {}
            ...
            : m_Alloc(alloc), m_Count(other.m_Count)
        {
            ...
            for (xpointer<SNode> pIt = other.m_pHead->pNext; pIt != other.m_pHead->pPrev; pIt = pIt->pNext)
        ...
        ~list()
        {
            for (xpointer<SNode> pIt = m_pHead->pNext; pIt != m_pHead; pIt = pIt->pNext)
            {
                pIt->Value.~T();
        ...
        list& operator=(const list& other)
        {
            ...
            xpointer<SNode> pThisNode = m_pHead->pNext;
            xpointer<SNode> pOtherNode = other.m_pHead->pNext;
            ...
            {
                xpointer<SNode> pNextNode = pThisNode->pNext;
        ...
        void assign(size_type count, const T& value)
        {
            ...
            xpointer<SNode> pNode = m_pHead->pNext;
            ...
            while (pNode != m_pHead)
            {
                xpointer<SNode> pNextNode = pNode->pNext;
        ...
        iterator insert(const_iterator pos, size_type count, const T& value)
        {
            if (count != 0)
            {
                ...
                m_Count.set(m_Count.value + count);

                xpointer<SNode> pNode = Emplace(pos.m_pNode, value);
                count--;

                xpointer<SNode> pResult = pNode;
        ...
        iterator insert(const_iterator pos, InputIt first, InputIt last)
        {
            if (first != last)
            {
                ...
                xpointer<SNode> pNode = Emplace(pos.m_pNode, *cur);
                ++cur;
        ...
        iterator erase(const_iterator pos)
        {
            ...
            xpointer<SNode> pNext = pos.m_pNode->pNext;
        ...
        iterator erase(const_iterator first, const_iterator last)
        {
            if (first != last)
            {
                ...
                xpointer<SNode> pNode = first.m_pNode;
                while (pNode != last.m_pNode)
                {
                    xpointer<SNode> pNext = pNode->pNext;
                    pNode->Value.~T();
                    m_Alloc.deallocate(pNode, 1);
                    pNode = pNext;
                    m_Count.set(m_Count.value - 1);
        ...
        void pop_back()
        {
            xpointer<SNode> pPrev = m_pHead->pPrev->pPrev;
        ...
        void pop_front()
        {
            xpointer<SNode> pNext = m_pHead->pNext->pNext;
    ...
    static_assert(sizeof(list<int>) == 0xC);
}
